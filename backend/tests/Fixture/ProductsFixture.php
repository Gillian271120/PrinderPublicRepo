...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'image_name' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_0900_ai_ci', 'comment' => '', 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2022-04-23 13:35:52',
                'modified' => '2022-04-23 13:35:52',
            ],
        ];
        parent::init();
    }
